...
const paths = {
  ...
  truck: <><rect x="1.5" y="6" width="13" height="10" rx="1" {...P} /><path d="M14.5 9h4l3 3v4h-7z" {...P} /><circle cx="6" cy="18" r="1.6" {...P} /><circle cx="18" cy="18" r="1.6" {...P} /></>,
  ...
  warehouse: <><path d="M3 21V8.4l9-4.4 9 4.4V21" {...P} /><path d="M2.5 21h19" {...P} /><rect x="8.5" y="12.5" width="7" height="8.5" {...P} /><path d="M8.5 16.6h7" {...P} /></>,
